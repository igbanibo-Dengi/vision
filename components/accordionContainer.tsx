        ...
        <div className='basis-1/2 md:p-2'>
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                At PixelHost, we offer a range of hosting solutions tailored to meet your specific needs. Our services include shared hosting, VPS hosting, dedicated servers, and cloud hosting. Whether you're a small business, an e-commerce store, or an enterprise, we have the right hosting solution to ensure your website performs optimally.
              </AccordionContent>
            </AccordionItem>
        ...
        <div className='basis-1/2 md:p-2'>
          <Accordion type="single" collapsible>
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                Yes, we offer a 30-day money-back guarantee on our hosting services. If you're not satisfied with our hosting within the first 30 days, we'll provide a full refund, no questions asked. Your satisfaction is our priority, and we're confident in the quality of our services.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent>
                Absolutely! We understand that your website's needs may evolve over time. You can easily upgrade your hosting plan to accommodate increased traffic, storage, and performance requirements. Our flexible plans ensure that your website can scale seamlessly as your online presence expands.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
